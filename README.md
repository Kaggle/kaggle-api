...
For Linux users, you can also run the `install` script for a system wide installation of `kaggle` (root access required). To see where the system binary is, run `which kaggle` on your Linux system.
