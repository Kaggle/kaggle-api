...
class KaggleApi(KaggleApi):
  ...
  valid_competition_sort_by = [
      'grouped', 'best', 'prize', 'earliestDeadline', 'latestDeadline', 'numberOfTeams',
      'relevance', 'recentlyCreated'
  ]
  ...
  def dataset_metadata_update(self, dataset, path):
    ...
    with open(meta_file, 'r') as f:
      ...
      with self.build_kaggle_client() as kaggle:
        ...
        settings.licenses=[self.new_license(l['name']) for l in metadata['licenses']]
  ...
  def dataset_metadata(self, dataset, path):
    ...
    with open(meta_file, 'w') as f:
      # Might want to filter out private fields (_field).
