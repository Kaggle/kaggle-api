...
ApiListDatasetFilesResponse._fields = [
    FieldMetadata(
        "datasetFiles", "dataset_files", "_dataset_files", ApiDatasetFile, [], ListSerializer(KaggleObjectSerializer())
    ),
    FieldMetadata("errorMessage", "error_message", "_error_message", str, None, PredefinedSerializer(), optional=True),
    FieldMetadata(
...
ApiListDatasetsRequest._fields = [
    ...
    FieldMetadata(
        "sortBy", "sort_by", "_sort_by", DatasetSortBy, DatasetSortBy.DATASET_SORT_BY_HOTTEST, EnumSerializer()
    ),
