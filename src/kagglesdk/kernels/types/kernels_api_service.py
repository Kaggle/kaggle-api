...
ApiGetKernelSessionStatusResponse._fields = [
    ...
    FieldMetadata(
        "failureMessage", "failure_message", "_failure_message", str, None, PredefinedSerializer(), optional=True
    ),
]
...
ApiKernelMetadata._fields = [
    ...
    FieldMetadata(
        "modelDataSources", "model_data_sources", "_model_data_sources", str, [], ListSerializer(PredefinedSerializer())
    ),
