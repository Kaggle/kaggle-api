...
class ApiDownloadModelInstanceVersionRequest(KaggleObject):
    ...
    def endpoint(self):
        if self.path:
            path = (
                "/api/v1/models/{owner_slug}/{model_slug}/{framework}/{instance_slug}/{version_number}/download/{path}"
            )
        else:
...
class ApiModelInstance(KaggleObject):
    ...
    def base_model_instance_information(
        self, base_model_instance_information: Optional[Optional["BaseModelInstanceInformation"]]
    ):
...
ApiListModelInstanceVersionFilesRequest._fields = [
    ...
    FieldMetadata(
        "versionNumber", "version_number", "_version_number", int, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata("pageSize", "page_size", "_page_size", int, None, PredefinedSerializer(), optional=True),
    FieldMetadata("pageToken", "page_token", "_page_token", str, None, PredefinedSerializer(), optional=True),
]
...
ApiModel._fields = [
    ...
    FieldMetadata(
        "instances", "instances", "_instances", ApiModelInstance, [], ListSerializer(KaggleObjectSerializer())
    ),
    ...
    FieldMetadata(
        "authorImageUrl", "author_image_url", "_author_image_url", str, None, PredefinedSerializer(), optional=True
    ),
]
...
ApiModelFile._fields = [
    ...
    FieldMetadata(
        "creationDate", "creation_date", "_creation_date", datetime, None, DateTimeSerializer(), optional=True
    ),
]
...
ApiModelInstance._fields = [
    ...
    FieldMetadata(
        "externalBaseModelUrl", "external_base_model_url", "_external_base_model_url", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
...
ApiReviewModelGatingUserConsentRequest._fields = [
    ...
    FieldMetadata(
        "publisherNotes", "publisher_notes", "_publisher_notes", str, None, PredefinedSerializer(), optional=True
    ),
]
...
WellKnowEndpointResponse._fields = [
    ...
    FieldMetadata(
        "claims_supported", "claims_supported", "_claims_supported", str, [], ListSerializer(PredefinedSerializer())
    ),
    FieldMetadata(
