...
from kagglesdk.discussions.types.search_discussions import (
    ...
    SearchDiscussionsWriteUpMetadata,
...
ListEntitiesResponse._fields = [
    FieldMetadata(
        "documents", "documents", "_documents", ListEntitiesDocument, [], ListSerializer(KaggleObjectSerializer())
    ),
...
ListEntitiesFilters._fields = [
    ...
    FieldMetadata(
        "listType", "list_type", "_list_type", ApiListType, ApiListType.API_LIST_TYPE_UNSPECIFIED, EnumSerializer()
    ),
    FieldMetadata("privacy", "privacy", "_privacy", PrivacyFilter, PrivacyFilter.ALL, EnumSerializer()),
    FieldMetadata(
        "ownerType", "owner_type", "_owner_type", OwnerType, OwnerType.OWNER_TYPE_UNSPECIFIED, EnumSerializer()
    ),
    FieldMetadata(
        "documentTypes", "document_types", "_document_types", DocumentType, [], ListSerializer(EnumSerializer())
    ),
    FieldMetadata(
        "competitionFilters",
        "competition_filters",
    ...
    FieldMetadata(
        "kernelFilters", "kernel_filters", "_kernel_filters", ApiSearchKernelsFilters, None, KaggleObjectSerializer()
    ),
    FieldMetadata(
        "modelFilters", "model_filters", "_model_filters", ApiSearchModelsFilters, None, KaggleObjectSerializer()
    ),
    FieldMetadata(
        "userFilters", "user_filters", "_user_filters", ApiSearchUsersFilters, None, KaggleObjectSerializer()
    ),
]
...
ApiSearchCompetitionsDocument._fields = [
    ...
    FieldMetadata(
        "ownerUserHasJoined", "owner_user_has_joined", "_owner_user_has_joined", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
...
ApiSearchDatasetsFilters._fields = [
    ...
    FieldMetadata(
        "licenseGroup", "license_group", "_license_group", DatasetLicenseGroup, None, EnumSerializer(), optional=True
    ),
...
ApiSearchDiscussionsDocument._fields = [
    FieldMetadata(
        "newCommentUrl", "new_comment_url", "_new_comment_url", str, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata("messageStripped", "message_stripped", "_message_stripped", str, "", PredefinedSerializer()),
    FieldMetadata(
        "messageMarkdown", "message_markdown", "_message_markdown", str, None, PredefinedSerializer(), optional=True
    ),
...
ApiSearchDiscussionsFilters._fields = [
    ...
    FieldMetadata(
        "writeUpTypes", "write_up_types", "_write_up_types", WriteUpType, [], ListSerializer(EnumSerializer())
    ),
]
...
ApiSearchKernelsDocument._fields = [
    ...
    FieldMetadata(
        "hasLinkedSubmission", "has_linked_submission", "_has_linked_submission", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
        "datasourceIsPrivate", "datasource_is_private", "_datasource_is_private", bool, False, PredefinedSerializer()
    ),
...
ApiSearchUsersDocument._fields = [
    FieldMetadata(
        "grandmasterTierLevel", "grandmaster_tier_level", "_grandmaster_tier_level", int, 0, PredefinedSerializer()
    ),
    ...
    FieldMetadata(
        "kernelRanking", "kernel_ranking", "_kernel_ranking", int, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata("kernelPoints", "kernel_points", "_kernel_points", int, None, PredefinedSerializer(), optional=True),
    FieldMetadata(
        "datasetRanking", "dataset_ranking", "_dataset_ranking", int, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata(
        "datasetPoints", "dataset_points", "_dataset_points", int, None, PredefinedSerializer(), optional=True
    ),
]

ApiSearchUsersFilters._fields = [
    FieldMetadata(
        "userLocations", "user_locations", "_user_locations", str, [], ListSerializer(PredefinedSerializer())
    ),
