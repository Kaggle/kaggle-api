...
GenerateAccessTokenRequest._fields = [
    ...
    FieldMetadata(
        "apiVersion", "api_version", "_api_version", ApiVersion, ApiVersion.API_VERSION_UNSPECIFIED, EnumSerializer()
    ),
    FieldMetadata(
        "expirationDuration", "expiration_duration", "_expiration_duration", timedelta, None, TimeDeltaSerializer()
    ),
    FieldMetadata(
...
AuthorizationContext._fields = [
    FieldMetadata(
        "kernelSessionId", "kernel_session_id", "_kernel_session_id", int, None, PredefinedSerializer(), optional=True
    ),
]
